...
- Approval scope: **brief accepted; one complete draft prepared, unactivated, 2026-09-14**. [Draft report and images](../../visuals/reviewed-sources/vestibule/draft-v1/REPORT.md). The owner authorized the layout/background, separate objects/effects and state composites while retaining procedural Inez. Personal visual review is pending. [Original room selection](../NEXT-ROOM-REVIEW.md).
...
- Retained source/master/display/provenance: [draft-v1 package](../../visuals/reviewed-sources/vestibule/draft-v1/REPORT.md), including source, exact import, authored layout and editable layers. Approved [street](../../visuals/street-activation/REPORT.md) and [Velvet](../../VELVET-CANONICAL-APPROVAL.md) supply visual continuity, not new geography.
...
No new rooms, windows, stairs, reception desk, queue, permanently present people or readable private entries. The draft explicitly resolves Inez's prose chair **off-camera beyond the near-right edge beside the book/ledge zone**, with no chair artwork, effect, permanent fixture or new entity. Procedural Inez remains a presence marker rather than a new seated pose. No timed heater controls, book-opening animation or bag contents unsupported by state.
...
The authorized draft now supplies a measured layout/anchors and masks, one clean source/imported plate, interior door views, separate object/effect layers and desktop/mobile state composites. Source replay, state ownership, custody/save/reload, fallbacks and unchanged approved-room checks passed. Inez artwork still requires its own identity review. Sources and editable layers follow the [existing import workflow](../../PROVIDER-NEUTRAL-ART-PIPELINE.md). Stop for personal visual review before activation or further art; no gameplay changes were made.
