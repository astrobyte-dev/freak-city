# Development reference — contains spoilers

This reference preserves the earlier development overview. For current public build status and setup, start with the [repository README](../README.md).
...
- [Autonomous interaction pass, validation and gap reporting](INTERACTION-PASS.md)
- [Parser pivot audit, implementation and authoring](PARSER-PIVOT.md)

- [Expansion results and duration evidence](EXPANSION-REPORT.md)
- [Blind human-playtest form](BLIND-PLAYTEST.md)
- [Build decisions](BUILD-PLAN.md)
- [Architecture and consequence propagation](ARCHITECTURE.md)
- [Story bible](STORY-BIBLE.md)
- [Character and voice bibles](CHARACTERS.md)
- [THE PULL, boundaries and pacing](THE-PULL.md)
- [Narrative authoring and expansion examples](AUTHORING.md)
- [Editorial review and known limitations](QA-AND-LIMITATIONS.md)
- [Artwork provenance and prompt](ASSETS.md)
